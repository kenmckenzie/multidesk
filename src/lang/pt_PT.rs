...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do MultiDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o MultiDesk não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o MultiDesk no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao MultiDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao MultiDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o MultiDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [MultiDesk Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep RustDesk background service", "Manter o serviço MultiDesk em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação MultiDesk, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show RustDesk", "Mostrar MultiDesk"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao MultiDesk as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao MultiDesk as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do MultiDesk em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do MultiDesk"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o MultiDesk e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o MultiDesk Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o MultiDesk de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo MultiDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do MultiDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do MultiDesk"),
        ...
        ("About RustDesk", "Sobre o MultiDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente MultiDesk para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o MultiDesk verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o MultiDesk recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o MultiDesk deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o MultiDesk server OSS não inclui esta funcionalidade."),
