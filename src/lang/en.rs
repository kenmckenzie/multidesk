...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the MultiDesk network..."),
        ...
        ("install_tip", "Due to UAC, MultiDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install MultiDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant MultiDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant MultiDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow MultiDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [MultiDesk Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next MultiDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant MultiDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant MultiDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running MultiDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verify MultiDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use MultiDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade MultiDesk Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent MultiDesk from running properly as controlled side."),
        ...
        ("About RustDesk", "About MultiDesk"),
        ("Show RustDesk", "Show MultiDesk"),
        ("Keep RustDesk background service", "Keep MultiDesk background service"),
        ("powered_by_me", "Powered by MultiDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if MultiDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep MultiDesk background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the MultiDesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, MultiDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, MultiDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, MultiDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: MultiDesk server OSS doesn't include this feature."),
